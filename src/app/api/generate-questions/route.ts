...
import { passageSections } from "@/data/passage";
...
For each section, generate exactly 2 questions. Vary difficulty across these levels:
...
Each question should require a typed (free-text) answer, not multiple choice. Questions should push students to think critically, not just locate facts.
