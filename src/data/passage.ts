import { PassageSection } from "@/lib/types";

export const passageTitle = "The Secret Life of Honeybees";

export const passageSections: PassageSection[] = [
  {
    id: "section-1",
    title: "The Hive & The Queen",
    content:
